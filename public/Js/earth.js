...
(function() {
    ...
    function init() {
        ...
        d3.select("#sponsor-hide").on("click", function() {sible
        ...
        bindButtonToConfiguration("#animate-winds", {param: "wind", surface: "surface", level: "level"});
        bindButtonToConfiguration("#animate-waves", {param: "waves", surface: "surface", level: "level"});
        

        bindButtonToConfiguration("#animate-currents-back", {param: "ocean", surface: "surface", level: "currents"});
        bindButtonToConfiguration("#animate-winds-back", {param: "wind", surface: "surface", level: "level"});
        bindButtonToConfiguration("#animate-waves-back",{param: "waves", surface: "surface", level: "level"});
